// 'main42.cc'
// This is an exact replica of mymain02.cc
// This is copied directly from the HepMC documentation at
// https://hepmc.web.cern.ch/hepmc/pythia8__example_8cc_source.html
