...
hepmc_file_10ns = "/Users/alaa/Downloads/MG5_aMC_v3_5_4/10ns_400GeV/Events/run_01/tag_1_pythia8_events.hepmc"
hepmc_file_zero_dot_1ns = "/Users/alaa/Downloads/0.1/tag_1_pythia8_events.hepmc"
...
print("Acceptance for 400GeV 10 ns is ", count_10ns, " out of 20000", " = ", count_10ns/20000)
...
print("Acceptance for 400GeV 0.1 ns is ", count, " out of 20000", " = ", count/20000)


c_10ns = ROOT.TCanvas("canvas_10", "Yield 10ns", 800, 600)
hist_10ns.Draw()
c_10ns.Update()
c_10ns.SaveAs("Yield_10ns__.pdf")

c = ROOT.TCanvas("canvas", "Yield", 800, 600)
hist.Draw()
c.Update()
c.SaveAs("Yield__.pdf")
